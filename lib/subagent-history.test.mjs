...
const { extractSubagentHistory, isSafeSubagentId, readCompletionArtifact, readSubagentTranscriptPage, resolveSubagentArtifact, siblingDirForSession, MAX_SUBAGENT_COMPLETION_BYTES } =
