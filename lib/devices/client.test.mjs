...
test("Bluetooth picker preserves compatibility hints and expands its explicit service grant", async () => {
  ...
  try {
    const info = await requestBluetoothDevice(["12345678-1234-5678-9abc-def012345678"]);
    assert.deepEqual(options.optionalServices, ["generic_access", "generic_attribute", "device_information", "battery_service", "6e400001-b5a3-f393-e0a9-e50e24dcca9e", "18f0", "fff0", "ffe0", "12345678-1234-5678-9abc-def012345678"]);
