...
test("Bluetooth picker preserves compatibility hints and expands its explicit service grant", async () => {
  ...
  try {
    ...
    assert.deepEqual(options.optionalServices, ["generic_access", "generic_attribute", "device_information", "battery_service", "6e400001-b5a3-f393-e0a9-e50e24dcca9e", "0x18f0", "0xfff0", "0xffe0", "12345678-1234-5678-9abc-def012345678"]);
