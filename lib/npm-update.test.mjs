...
// The update source reads `cody-forge.json` from the agent dir; on an instance
// that points its update source at a self-hosted forge the expected GitHub
// defaults would never be produced. Isolate BEFORE the first import.
process.env.PI_CODING_AGENT_DIR = mkdtempSync(join(tmpdir(), "cody-npm-update-"));
