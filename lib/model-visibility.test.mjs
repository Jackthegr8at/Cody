...
test("users and engines are independent, and emptied entries leave the file", () => {
  ...
  store.writeUserVisibility("u1", "codex", { hidden: ["h/1"] });
  ...
  assert.deepEqual(store.readUserVisibility("u1", "codex"), { hidden: ["h/1"], pinned: [] });
  assert.deepEqual(store.readUserVisibility("u2", "codex"), { hidden: [], pinned: [] });

  store.writeUserVisibility("u1", "pi", { hidden: [], pinned: [] });
  store.writeUserVisibility("u1", "codex", { hidden: [] });
